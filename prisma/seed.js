    ...
    for (const s of sightingData) {
        ...
        const sighting = await prisma.sighting.create({
            data: {
                ...
                tags: { create: s.tags.map((t) => ({ tag: t })) },
            },
        });
